...
from Core.tweetnacl import (crypto_secretbox_xsalsa20poly1305_tweet,crypto_secretbox_xsalsa20poly1305_tweet_open,crypto_scalarmult_curve25519_tweet_base,crypto_box_curve25519xsalsa20poly1305_tweet_beforenm)
...
class Crypto:
    def __init__(self):
        self.server_private_key = bytes.fromhex("5E7157A6C771CA7A9688EC34CFDB0A3A28FA784B16AEB73F923f0F37C9094D3A") # Used server pk key as server sk key 
        self.server_public_key = bytearray(32) # Put in "randombytes" function in libg product of scalar base multipiction from server pk key
